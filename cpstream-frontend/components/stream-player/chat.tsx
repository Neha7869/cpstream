...
export function Chat({
  ...
  const liveMessages = useMemo(() => {
    return messages.map((msg) => {
      ...
      // Fixed condition: fallback to local context check if identity evaluation is mismatched
      const isCurrentUser = identity === viewerIdentity || msg.from?.name === viewerName;
